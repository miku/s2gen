// Autogenerated by s2gen 0.1.0 on 2018-11-04T21:03:00+01:00 by tir on sol.
...
// VuFindBibliographicIndexVersion0 generated from schema.
...
type VuFindBibliographicIndexVersion0 struct {
...
// NewVuFindBibliographicIndexVersion0 creates a new document conforming to a schema for the dynamic fields.
func NewVuFindBibliographicIndexVersion0() *VuFindBibliographicIndexVersion0 {
	return &VuFindBibliographicIndexVersion0{
		fields: []*dynamicField{
...
func (v *VuFindBibliographicIndexVersion0) MarshalJSON() ([]byte, error) {
	temp := structs.Map(v)
...
func (v *VuFindBibliographicIndexVersion0) UnmarshalJSON(pp []byte) error {
	*v = *NewVuFindBibliographicIndexVersion0()
...
func (v *VuFindBibliographicIndexVersion0) DynamicFieldnames() (names []string) {
...
func (v *VuFindBibliographicIndexVersion0) DynamicFields(name string) (map[string][]string, error) {
	for _, f := range v.fields {
		if f.name == name {
			return f.fmap, nil
		}
...
func (v *VuFindBibliographicIndexVersion0) Field(name string) (*dynamicField, error) {
	for _, field := range v.fields {
		if field.name == name {
			return field, nil
		}
...
func (v *VuFindBibliographicIndexVersion0) MustField(name string) *dynamicField {
...
func main() {
	...
	doc := NewVuFindBibliographicIndexVersion0()
